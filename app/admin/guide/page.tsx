  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-8 space-y-8">
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-neutral-700">
          各スライドには <code className="rounded bg-neutral-100 px-1 py-0.5 text-xs">visibility</code>{" "}
          という公開レベルがあります。
        </p>
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-neutral-700">
          <li>
            ...
            <ul className="mt-1 list-disc space-y-1 pl-5">
              ...
              <li>招待コード <code className="rounded bg-neutral-100 px-1 py-0.5 text-xs">shoku-iku-hayama</code>{" "}
                を作成し、対象スライドにチェック</li>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-neutral-700">
          管理者かどうかは Supabase の <code className="rounded bg-neutral-100 px-1 py-0.5 text-xs">profiles</code>{" "}
          テーブルの <code className="rounded bg-neutral-100 px-1 py-0.5 text-xs">is_admin</code>{" "}
          で管理します。
        </p>
        <ul className="list-disc space-y-1 pl-5 text-sm text-neutral-700">
